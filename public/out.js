...
if (Module["locateFile"]) {
 wasmBinaryFile = "qemu-system-riscv32.wasm";
 if (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
 }
} else {
 wasmBinaryFile = new URL("qemu-system-riscv32.wasm", import.meta.url).href;
}
...
var PThread = {
 ...
 allocateUnusedWorker() {
  var worker;
  if (!Module["locateFile"]) {
   worker = new Worker(new URL("qemu-system-riscv32.worker.js", import.meta.url), {
    type: "module"
   });
  } else {
   var pthreadMainJs = locateFile("qemu-system-riscv32.worker.js");
...
var ___start_em_js = Module["___start_em_js"] = 3664440;

var ___stop_em_js = Module["___stop_em_js"] = 3677145;
